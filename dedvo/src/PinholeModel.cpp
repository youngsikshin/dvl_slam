...
// Eigen::Vector3f PinholeModel::uv_to_xyz(const Eigen::Vector2f& uv)
// {
...
vector<Eigen::Vector2f> PinholeModel::pointcloud_to_uv(const PointCloud& pc, float scale)
{
    vector<Eigen::Vector2f> uv_set;
