...
enum class ScaleEstimatorType{None, TDistributionScale};
enum class WeightFunctionType{None, TDistributionWeight, HuberWeight};

class ScaleEstimator
{
public:
    typedef shared_ptr<ScaleEstimator> Ptr;
...
{
public:
    typedef shared_ptr<TDistributionScaleEstimator> Ptr;
...
{
public:
    typedef shared_ptr<WeightFunction> Ptr;
...
{
public:
    typedef shared_ptr<TDistributionWeightFunction> Ptr;
...
{
public:
  typedef shared_ptr<HuberWeightFunction> Ptr;
