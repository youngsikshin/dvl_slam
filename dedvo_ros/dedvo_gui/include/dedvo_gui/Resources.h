...
//     _cam_lidar_queue_t() {};
//     ~_cam_lidar_queue_t() {};
//     boost::lockfree::queue<const uint32_t *> timestamp_queue;
//     boost::lockfree::queue<const cv::Mat> img_queue;
//     boost::lockfree::queue<const pcl::PointCloud<pcl::PointXYZI> *> pc_queue;
// };
...
//    std::queue<cv_bridge::CvImagePtr> img_queue;
//    std::queue<pcl::PointCloud<pcl::PointXYZI>::Ptr> pc_queue;
